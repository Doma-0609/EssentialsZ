...
final class PermissionsHandler{
	...
	private const PERMISSIONS = [
		...
		"essentialsz.scale" => "Allows access to the /scale command",
		"essentialsz.scale.others" => "Allows changing the size of other players",
		"essentialsz.spider" => "Allows access to the /spider command",
		"essentialsz.spider.others" => "Allows toggling wall climbing for other players",
		"essentialsz.repair" => "Allows access to the /repair command",
